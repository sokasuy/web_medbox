...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{ asset('assets/dist/img/MedboXLOGO.png') }}" alt="MedboXLOGO" height="60" width="60">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('dashboard.home') }}" class="brand-link">
      <img src="{{ asset('assets/dist/img/MedboXLOGO.png') }}" alt="Medbox Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
